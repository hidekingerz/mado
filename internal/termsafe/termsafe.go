// Package termsafe prepares text that came from disk for display on a
// terminal.
package termsafe
...
// String makes a string safe to print to the terminal by
...
// isControl reports whether r is a control character a terminal
